...
$outline .= '<div id="sp-logo-carousel-pro' . $custom_id . '" class="sp-logo-carousel-pro-area' . $preloader_class . ' lcp-container ' . ( 'true' == $tooltip ? 'splcp-ttip' : '' ) . '" >';
...
if ( $page_que->have_posts() ) {
	while ( $page_que->have_posts() ) :
		...
		$outline .= '<div role="tabpanel" tabindex="0" class="lcp-col-lg-' . $items . ' lcp-col-md-' . $items_desktop . ' lcp-col-sm-' . $items_tablet . ' lcp-col-xs-' . $items_mobile . '">';
