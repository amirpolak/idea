...
include_once('Responder_InstallIndicator.php');

class Responder_LifeCycle extends Responder_InstallIndicator {
    ...
    protected function addSettingsSubMenuPageToPluginsMenu() {
        ...
        add_menu_page( $displayName, $displayName , 'manage_options', $this->getSettingsSlug(), array(&$this, 'settingsPage'),'dashicons-rss');
    }
