 ...
 * @since 1.0.0
 */
class Control_Select_Responder_RTL extends Base_Data_Control {
	...
	public function content_template() {
		...
		<div class="elementor-control-field" style="direction:rtl;">
			...
			<# if ( data.label ) {#>
				<label for="<?php echo $control_uid; ?>" class="elementor-control-title" style="padding-left:5px;">{{{ data.label }}}</label>
			<# } #>
