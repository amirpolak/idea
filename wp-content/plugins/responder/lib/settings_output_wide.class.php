...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	class UniteSettingsOutputWideRes extends UniteSettingsOutputResWork{
		...
		protected function drawSettingRow($setting, $mode = ""){
			...
			//set cellstyle:
			$cellStyle = "";
			if(isset($setting[UniteSettingsRes::PARAM_CELLSTYLE])){
				$cellStyle .= $setting[UniteSettingsRes::PARAM_CELLSTYLE];
			}
			...
			$addField = UniteFunctionsRes::getVal($setting, UniteSettingsRes::PARAM_ADDFIELD);
			...
			if(!empty($addField)):
				...
				UniteFunctionsRes::validateNotEmpty($addSetting,"AddSetting {$addField}");
				...
				$addSettingText = UniteFunctionsRes::getVal($addSetting,"text","");
		...
		protected function drawHrRow($setting){
			...
			$class = UniteFunctionsRes::getVal($setting, "class");
			if(!empty($class))
				$class = "class='$class'";
		...
		protected function drawTextRow($setting){
			...
			$label = UniteFunctionsRes::getVal($setting, "label");
			if(!empty($label))
				$tdHtmlAdd = "";
